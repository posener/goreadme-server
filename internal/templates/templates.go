			...
			<div class="col-lg-4 col-12 mx-auto">
				<div class="jumbotron">
					...
					<button type="submit" class="btn btn-outline-primary">
						<i class="fa-2x fa-github" aria-hidden="true"></i>
						Login with Github
					</button>
					</form>
				</div>
...
{{ define "headline" }}
<div class="row row border-top rounded-sm bg-light" style="height: 50px;">
...
var trigger = template.Must(base.Parse(`
{{ define "trigger" }}
...
<div class="row mt-md-2">
	...
	<div class="col-lg-7 col-11 p-2 pl-3 pr-3 p-lg-2">
		{{ template "message" . }}
	</div>
